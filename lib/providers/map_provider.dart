...
const String fields = 'fields=photos,formatted_address,name,rating,opening_hours,geometry';
const String radius = 'radius=5000';
const String key = 'key=AIzaSyAWdJUdZD75aDBqMMAT3RITwbjqMAs5WVw';
const String base = 'https://maps.googleapis.com/maps/api/place/nearbysearch/json?';
